...
RUN yum install -y http://repo1.sea.innoscale.net/remi/enterprise/remi-release-7.rpm \
  && yum install -y php71-php-fpm php71-php-cli php71-php-pdo php71-php-mysqlnd php71-php-gd php71-php-mbstring php71-php-xml php71-php-json php71-php-pecl-zip php71-php-pecl-mongodb php71-php-pecl-pthreads\
