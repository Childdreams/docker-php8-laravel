...
RUN yum install -y http://repo1.sea.innoscale.net/remi/enterprise/remi-release-7.rpm \
  && yum install -y php73-php-fpm php73-php-cli php73-php-pdo php73-php-mysqlnd php73-php-gd php73-php-mbstring php73-php-xml php73-php-json php73-php-pecl-zip php73-php-pecl-mongodb \
